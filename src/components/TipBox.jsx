          ...
          <div class="col-lg-6 pb-3 pt-3">
            <div class="pb-3 pt-3">
              ...
              <p class="fw-light mb-0">
                ...
                de TODOS os transtornos mentais. Ela traz muitos benefícios
                psíquicos e físicos que são importantes aliados no processo
                terapêutico. Basicamente qualquer esporte é indicado, a depender
                do que convêm à pessoa, mas aqui vão algumas dicas se você ainda
                não tentou nada ou não conhece o seu perfil de atividade física:
                - Para transtornos ansiosos: exercícios aeróbicos, como dança,
                yoga, atletismo, treino funcional, natação, artes marciais; -
                Para transtorno do espectro autista: esportes na água;
              </p>
            </div>
            <div class="pb-3 pt-3">
              ...
              <p class="fw-light mb-0">
                ...
                mentais, tanto com o objetivo de psicoeducação (aprender sobre
                transtornos mentais), quanto com o objetivo de se identificar
                com pessoais que já passaram ou estão passando por isso,
                ajudando a seguir em frente. Algumas dicas de livros e filmes
                estão presentes no meu instagram: @livrosepsiquiatria
              </p>
            </div>{" "}
            <div class="pb-3 pt-3">
              ...
              <p class="fw-light mb-0">
                ...
                tratamento de depressão, transtornos de ansiedade e compulsão
                alimentar em uma série de estudos científicos. Existem programas
                e cursos de atenção plena que você pode procurar para fazer, mas
                também existem aplicativos de celular como Lojong, Aura, Omvana
                etc., que possuem exercícios diários de meditação guiada que
                ajudam na respiração consciente, no comer consciente e no
                desenvolvimento de atenção plena durante nosso dia, evitando
            ...
            <div class="pb-3 pt-3">
              ...
              <p class="fw-light mb-0">
                ...
                yoga, eles são chamados de “pranayamas” e há uma infinidade
                deles, cada um com um benefício. Um tipo muito simples de
                exercício de respiração que pode auxiliar durante uma crise de
                ansiedade ou um ataque de pânico é: inspire (puxe o ar) em 5
                segundos; segure o ar nos pulmões por 3 segundos; expire (solte
                o ar) por 7 segundos; segure os pulmões esvaziados por 3
                segundos e recomece.
              </p>
            </div>{" "}
            <div class="pb-3 pt-3">
              ...
              <p class="fw-light mb-0">
                ...
                transtornos ansiosos, e podem ser usados quando o paciente tem
                um quadro leve e muita resistência a psicofármacos.
              </p>
            </div>{" "}
            <div class="pb-3 pt-3">
              ...
              <p class="fw-light mb-0">
                ...
                de transtornos ansiosos. Pode ser usado em blend e colocado no
                travesseiro ou na roupa para que a pessoa exale durante o dia/ a
                noite. No entanto, deve ser um complemento do tratamento e não
                usado como único recurso, exceto em casos muito leves.
              </p>
            </div>
          </div>
        </div>
